...
#########################################################################################
    ...
    print ("AARON TIME")
    for i in range(1):
      input_midi_1 = os.path.expanduser('preprocessed_midi/new_3note_section%d.mid' % i)
      input_1 = note_seq.midi_file_to_note_sequence(input_midi_1)
      input_midi_2 = os.path.expanduser('preprocessed_midi/new_3note_section%de.mid' % i)
      input_2 = note_seq.midi_file_to_note_sequence(input_midi_2)
      try:
